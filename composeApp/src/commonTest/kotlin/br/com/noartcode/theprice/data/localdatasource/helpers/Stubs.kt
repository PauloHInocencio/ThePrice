...
val stubBills:List<Bill> by lazy {
    listOf(
        Bill(
            ...
            price = 12099,
            createAt = DayMonthAndYear(day = 5, month = 9, year = 2024)
        ),
        Bill(
            name = "Mom's Internet",
            description = "Mom's internet bill.",
            price = 9999,
            createAt =  DayMonthAndYear(day = 5, month = 8, year = 2024)
        ),
        Bill(
            name = "Rent",
            description = "This is how much I currently pay for rent.",
            price = 220000,
            createAt =  DayMonthAndYear(day = 5, month = 7, year = 2024)
        ),
        Bill(
            name = "Health insurance",
            description = "Unimed's health insurance.",
            price = 190098,
            createAt =  DayMonthAndYear(day = 5, month = 6, year = 2024)
        ),
        Bill(
            name = "Son's School",
            description = "My son's school",
            price = 80000,
            createAt =  DayMonthAndYear(day = 5, month = 5, year = 2024)
        ),
        Bill(
            name = "Condo",
            description = "Condominium of my rented apartment.",
            price = 55000,
            createAt =  DayMonthAndYear(day = 5, month = 4, year = 2024)
        ...
        Bill(
            ...
            price = 800000,
            createAt =  DayMonthAndYear(day = 5, month = 3, year = 2024)
        ),
        Bill(
            name = "Accountant",
            description = "My Accountant.",
            price = 800000,
            createAt =  DayMonthAndYear(day = 5, month = 2, year = 2024)
        ),
        Bill(
            name = "Myself",
            description = "The money I save.",
            price = 0,
            createAt =  DayMonthAndYear(day = 5, month = 1, year = 2024)
        )
    )
}
