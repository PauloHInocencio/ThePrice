...
val stubBills:List<Bill> by lazy {
    listOf(
        Bill(
            ...
            price = 12099,
            invoiceDueDay = 5,
            createAt = DayMonthAndYear(day = 2, month = 9, year = 2024)
        ),
        Bill(
            name = "Mom's Internet",
            ...
            price = 9999,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 8, year = 2024)
        ),
        Bill(
            name = "Rent",
            ...
            price = 220000,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 7, year = 2024)
        ),
        Bill(
            ...
            price = 190098,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 6, year = 2024)
        ),
        Bill(
            name = "Son's School",
            ...
            price = 80000,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 5, year = 2024)
        ),
        Bill(
            name = "Condo",
            ...
            price = 55000,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 4, year = 2024)
        ...
        Bill(
            ...
            price = 800000,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 3, year = 2024)
        ),
        Bill(
            name = "Accountant",
            ...
            price = 800000,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 2, year = 2024)
        ),
        Bill(
            name = "Myself",
            ...
            price = 0,
            invoiceDueDay = 5,
            createAt =  DayMonthAndYear(day = 2, month = 1, year = 2024)
        )
    )
}
